"""
Django settings for Gitacora_django project.
...
ALLOWED_HOSTS = ['blog-app-nine-mu.vercel.app','now.sh','127.0.0.1','localhost']
...
ROOT_URLCONF = 'Gitacora_django.urls'
...
WSGI_APPLICATION = 'Gitacora_django.wsgi.application'
